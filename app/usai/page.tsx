...
export default function UnitedSchoolOfAI(){
    return(
        <div className={'flex flex-col gap-8 container min-h-screen py-16'}>
            <h1 className={'text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight'}>United School of Artificial Intelligence</h1>
            ...
            <div>
                <h2 className={'text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight'}>Kindergarten (K.G.) STEM Entrepreneurs</h2>
                <p className={'text-lg md:text-xl lg:text-2xl xl:text-3xl leading-relaxed py-8'}>
            ...
            <div>
                <h2 className={'text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight'}>Learning Roadmap</h2>
                <ul className={' flex flex-col gap-6 text-lg md:text-xl lg:text-2xl xl:text-3xl leading-relaxed py-6'}>
