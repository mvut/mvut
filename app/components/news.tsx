    ...
    return (
        <div className={'flex flex-col items-center justify-center p-4 '}>
                ...
                <div className={'grid grid-cols-1 lg:grid-cols-4 gap-10 py-10 '}>
                    <div className={'flex flex-col h-full sm:w-auto hover:bg-slate-100 transition-all ease-in-out delay-200 border-2 border-slate-100'}>
                        <div className={'px-6 py-4'}>
                            ...
                            <p className={'text-sm leading-relaxed '}>
                                ...
                                design, develop, and maintain dynamic web applications. Covering latest technologies and best
                                practices, WTST prepares students for in-demand digital careers, including Web Developer, Web
                                Designer, and
                            ...
                            <div
                                ...
                                <Link href={'/pages/apply'} className={'hover-fill flex items-center justify-center '}>
                    ...
                    <div
                        ...
                        <div className={'px-6 py-4'}>
                            ...
                            <div
                                className={'flex h-9 w-24 my-6 hover:bg-red-600 text-amber-300 rounded-md bg-red-800 transition-all ease-in-out delay-200'}>
                                <Link href={'/pages/honrarydoctorate'} className={'hover-fill flex items-center justify-center '}>
                                    <p className={'p-2 h-full uppercase '}>Apply</p>
                                    <div className={'flex items-center justify-start  h-10 w-10 '}>
                                        <FaArrowUpRightFromSquare/>
                                    </div>
                    ...
                    <div
                        ...
                        <div className={'px-6 py-4'}>
                            ...
                            <div
                                className={'flex h-9 w-24 my-6 hover:bg-red-600 text-amber-300 rounded-md bg-red-800 transition-all ease-in-out delay-200'}>
                                <Link href={'/pages/study'} className={'hover-fill flex items-center justify-center '}>
