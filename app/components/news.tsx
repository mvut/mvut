        ...
        <section>
            ...
            <div className="flex gap-6">
                <div className="flex flex-col w-2/4 bg-indigo-950 text-white px-12 py-12 gap-6">
                    <p className="text-md text-red-600">5 September 2024</p>
                    ...
                    <h2 className="text-xl font-bold text-amber-200">Don&apos;t Miss Out!</h2>
                    <p className={''}> <Link href={'pages/apply'} className={'underline text-red-600 font-bold'}>Apply</Link> now to secure your spot and take the first step towards a rewarding career in AI and Web
                        development.</p>
                </div>
