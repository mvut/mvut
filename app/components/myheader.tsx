...
export default function MyHeaderComponent(){
    return(
        <div className={'flex h-auto flex-col sm:flex-row items-center justify-between py-4 px-8 w-full text-white bg-neutral-950'}>
            ...
            <div className={'flex text-md gap-2 sm:gap-4  py-6'}>
                <Link href={'/'}
                      className={'underline-animation '}>Home</Link>
                <Link href={'/pages/services'}
                      className={'underline-animation '}>Services</Link>
                ...
                <Link href={'/pages/research'}
                      className={'underline-animation'}>Research</Link>
