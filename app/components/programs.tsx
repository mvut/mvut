export default function ProgramComponent(){
    return (
        <div className="flex flex-col container mb-8 mx-auto py-10 items-center justify-center text-center">
            <p className="text-3xl text-teal-950 font-bold">Services</p>
