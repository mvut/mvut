...
export default function SloganPage(){
    ...
    // }, [applicants]);
    return (
        <div className="flex flex-col md:flex-row md:p-4 py-8 md:py-16 bg-teal-900 w-full items-center justify-center">
            <div className={'flex items-center justify-center flex-col md:w-1/3 md:leading-relaxed '}>
                <p className={'text-xl py-4 leading-relaxed text-teal-200 md:text-5xl md:py-10'}> Admission open</p>
