...
export default function StudySchemeComponent(){
    return(
        <div className={'container flex flex-col sm:py-16 my-10'}>
            ...
            <h2 className={'text-lg sm:text-4xl'}>Certificate of Philosophy in Web Development (CPWD)</h2>
            <div className={'flex flex-col items-start justify-center py-4 sm:py-10'}>
                ...
                <div className={'flex text-sm sm:text-lg gap-2'}>
                    ...
                    <p className={'text-red-700'}>111(Theory:60, Practical:51)</p>
                </div>
            </div>
            ...
            <table className={"table-auto text-center text-xs sm:text-lg"}>
                ...
                <tr>
                    <td>3</td>
                    <td>MVC-55</td>
                    <td className={'text-start'}>Research Methodologies</td>
                    <td>1</td>
                ...
                <tr>
                    <td>21</td>
                    <td>MVC-90</td>
                    <td className={'text-start'}>Thesis/Desertion</td>
                    <td>5,6</td>
                    <td>6 (Theory:3, Practical:3)</td>
                </tr>
                </tbody>
